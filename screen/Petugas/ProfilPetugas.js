...
import { themeColors } from '../../theme/theme'; // Adjust the import path as necessary
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.navbar}>
        ...
        >
          ...
          <TouchableOpacity onPress={() => navigation.navigate("HCpetugas")} style={styles.navItem}>
            <View style={styles.navIconContainer}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("ProfilPetugas")} style={[styles.navItem, styles.activeNavItem]}>
